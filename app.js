...
function calculate4AT() {
  ...
  if (score === 0) {
    ...
    $("#title4at").textContent = "Posible deterioro cognitivo";
    $("#text4at").textContent = "Buscar estado basal y causas. Mantener prevención y seguimiento según riesgo.";
  } else {
    box.classList.add("high");
    $("#title4at").textContent = "Posible delirium";
    $("#text4at").textContent = "Aplicar CAM, obtener información basal y realizar evaluación clínica de causas.";
  }
  return score;
}
...
function calculateCAM() {
  ...
  $("#textCam").textContent = positive
    ? "Delirium probable: comunicar al equipo, identificar causas y activar manejo."
