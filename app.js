...
$$("[data-go]").forEach(btn => btn.addEventListener("click", () => {
  ...
  if (btn.dataset.manageTab) activateManagementTab(btn.dataset.manageTab);
}));
...
function activateManagementTab(id) {
  $$(".management-tab").forEach(t => t.classList.toggle("active", t.dataset.manageTarget === id));
  $$(".management-panel").forEach(p => p.classList.toggle("active", p.id === id));
}
$$(".management-tab").forEach(t => t.addEventListener("click", () => activateManagementTab(t.dataset.manageTarget)));
...
function getInstallInstructions() {
  ...
  if (location.protocol !== "https:" && location.hostname !== "localhost") {
    return `<div class="alert warning"><b>Primero debes publicar la app.</b><br>El archivo ZIP o una apertura mediante <code>file://</code> no permite instalar una PWA. Súbela a GitHub Pages y abre esa dirección desde el navegador.</div>`;
  }
  if (isIOS) {
    return `<ol class="mini-flow"><li>Abre esta página en <b>Safari</b>.</li><li>Toca el botón <b>Compartir</b> (cuadrado con flecha).</li><li>Selecciona <b>Agregar a pantalla de inicio</b>.</li><li>Confirma con <b>Agregar</b>.</li></ol>`;
  }
  if (isAndroid) {
    return `<ol class="mini-flow"><li>Abre esta página en <b>Chrome</b>.</li><li>Toca el menú de <b>tres puntos</b>.</li><li>Selecciona <b>Instalar aplicación</b> o <b>Agregar a pantalla principal</b>.</li><li>Confirma la instalación.</li></ol>`;
  }
  return `<ol class="mini-flow"><li>Abre el menú del navegador.</li><li>Busca <b>Instalar Delirium HCFB</b> o <b>Instalar aplicación</b>.</li><li>También puede aparecer un ícono de instalación al extremo derecho de la barra de direcciones.</li></ol>`;
}
...
function updateInstallUI() {
  ...
  if (isStandalone()) {
    ...
    status.textContent = "La aplicación ya está instalada en este dispositivo.";
  } else if (installPrompt) {
    button.textContent = "Instalar aplicación";
    button.disabled = false;
    status.textContent = "Tu navegador permite instalarla directamente.";
  } else {
    button.textContent = "Ver cómo instalar";
    button.disabled = false;
    status.textContent = location.protocol === "https:" ? "La instalación se realiza desde el menú del navegador." : "Primero debes publicarla en una dirección HTTPS.";
  }
}
